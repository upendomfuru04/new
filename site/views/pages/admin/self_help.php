                            ...
                            <table id="dataTable" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-break-sm"><?php echo ucwords($post->subcategory); ?></td>
                                        <td class="no-break-sm break-all"><?php echo $url; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url();?>admin/blog/edit_self_help/<?php echo $post->id;?>" class="text-info"><i class="fa fa-edit"></i></a>
                                            <a href="javascript:void();" onclick="deletePost('<?php echo base_url()."admin/blog/delete_self_help/".$post->id;?>');" class="text-danger"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
