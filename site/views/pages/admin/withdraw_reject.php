            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"> Withdrawal Rejected</h3>
                    </div>
                    <div class="panel-body p40">
                        <div class="table-responsive pb20 pt20">
                            <p><?php if(sizeOf($withdraw_reject)==0){ echo 'No any withdraw request rejected...';}?></p>
                            <table id="dataTable" class="table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php 
                                        $counter=0; 
                                        foreach($withdraw_reject as $request){
                                            $counter++;
                                            $request_status="";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void();" onclick="withdrawRequest('<?php echo $request->seller_id; ?>', '<?php echo $request->full_name; ?>', '<?php echo $request->requestID; ?>', '<?php echo $request->amount; ?>', '<?php echo $total; ?>');" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Approve</a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php } ?>
