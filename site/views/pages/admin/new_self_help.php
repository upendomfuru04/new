...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#saveBtn').click(function(){
           ...
           $.ajax({
               url: '<?php echo base_url(); ?>admin/blog/save_self_help',
               type: 'POST',
               data: formData,
               async: true,
               cache: false,
        ...
        $('#updateBtn').click(function(){
           ...
           var formData = new FormData($('#data-form')[0]);
           $.ajax({
               url: '<?php echo base_url(); ?>admin/blog/update_self_help/<?php echo $update; ?>',
               type: 'POST',
               data: formData,
               async: true,
               cache: false,
               ...
               success: function (data) {
                    if(data.trim()=='Success'){
                        ...
                        $('#resultMsg').html(output);
                        document.getElementById("data-form").reset();
                        window.location="<?php echo base_url(); ?>admin/blog/self_help";
                    }else{
                        $('#resultMsg').html(data);
                    }
                    $('.turnOnProgress').css('display','inline-block');
  ...
  function load_sub_category(){
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>Admin/blog/load_sub_categories/'+category,
        type:"POST",
        success: function(data){
