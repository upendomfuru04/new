                            ...
                            <table id="dataTable" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?=base_url()?>admin/blog/post_details/<?php echo $post->id;?>" class="text-success" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>
                                            <a href="<?=base_url()?>admin/blog/edit_post/<?php echo $post->id;?>" class="text-info"><i class="fa fa-edit"></i></a>
