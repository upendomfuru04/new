                            ...
                            <?php echo form_open_multipart('users/update_seller_profile',array('method'=>'post')); ?>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" name="full_name" class="form-control" value="<?php echo $user_info['full_name']; ?>">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Address:</label>
                                        <input type="text" name="address" class="form-control" value="<?php echo $user_info['address']; ?>" placeholder="eg. P. O. Box 0000">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>PostCode:</label>
                                        <input type="text" name="postCode" class="form-control" value="<?php echo $user_info['postCode']; ?>">
                                    </div>
                                    <div class="col-md-12 p-t-10">
                                        <input type="submit" class="btn btn-success" value="Save" />
                                        <!-- <button type="submit" class="btn btn-success" name="register-form-submit"><i class="ti-save"></i> Save</button> -->
                                    </div>
                                </div>
                            </form>
                        </div>
