                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body row p40">
                        <div class="col-md-8">
                        	...
                        	<hr >
                        	<p class="text-justify"><?php echo preg_replace('#(<br */?>\s*)+#i', '<br />', $table_rows['content']); ?></p>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <hr>
                            <a href="<?php echo base_url(); ?>seller/blog/edit_post/<?php echo $table_rows['id'];?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
                            <?php if($table_rows['is_approved']=='1'){ ?>
                            <a href="javascript:void();" class="btn btn-sm btn-success" onclick="approvePost('<?php echo base_url()."seller/blog/approve_post/".$table_rows['id'];?>');"><i class="fa fa-check"></i> Approve</a>
    ...
    function denyPost(data){
        ...
        if(reason!=""){
            ...
            if (confirm("Are you sure you want to deny this post?")) {
                $.ajax({
                    url: '<?php echo base_url()?>seller/blog/deny_post/'+data+'?reason='+reason,
                    type:"POST",
                    async: true,
                    processData: false,
