                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void();" class="btn btn-xs btn-success" onclick="approvePost('<?php echo base_url()."seller/blog/approve_post/".$post->id;?>');"><i class="fa fa-check"></i> Approve</a>
                                            <?php }?>
                                            ...
                                            <a href="<?php echo base_url(); ?>seller/blog/edit_blog_post/<?php echo $post->id;?>" class="text-info"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
